...
meta = [
    ...
    "arguments" : [
      {
        ...
        "description" : "Input files or directories with ';' as delimiter",
        "example" : [
          "file1;file2;..."
        ],
        "must_exist" : true,
      ...
      },
      {
        ...
        "description" : "One directory containing all input files/dirs",
        "example" : [
          "report"
        ],
        "must_exist" : true,
    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/Users/toni/code/projects/viash-hub/vsh_utils/src/join/assemble/"
      }
    ],
    "description" : "Collect all input files/dirs into one output dir\nfor downstream processing.\n",
    "status" : "enabled",
    "requirements" : {
      "commands" : [
        "ps"
  ...
  "platforms" : [
    ...
    },
    {
      ...
      "id" : "docker",
      "image" : "ubuntu:latest",
      "target_organization" : "data-intuitive/vsh_utils",
      "target_registry" : "viash-hub.com:5050",
      "namespace_separator" : "/",
      "resolve_volume" : "Automatic",
      "chown" : true,
      "setup_strategy" : "ifneedbepullelsecachedbuild",
      "target_image_source" : "https://viash-hub.com/data-intuitive/vsh_utils"
    }
  ],
  "info" : {
...
for file in \\$files; do
  echo "Adding \\$file to the collection"
...
meta["defaults"] = [
  ...
  "container" : {
    ...
    "image" : "data-intuitive/vsh_utils/join/assemble",
    "tag" : "0.1.0"
  },
  "tag" : "$id"
}'''),
