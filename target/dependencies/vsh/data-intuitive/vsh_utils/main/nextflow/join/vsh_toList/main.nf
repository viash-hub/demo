...
meta = [
    ...
    "resources" : [
      {
        ...
        "path" : "main.nf",
        "is_executable" : true,
        "parent" : "file:/Users/toni/code/projects/viash-hub/workflow_utils/src/join/vsh_toList/",
        "entrypoint" : "run_wf"
      }
    ],
  ...
  "info" : {
    "config" : "/Users/toni/code/projects/viash-hub/workflow_utils/src/join/vsh_toList/config.vsh.yaml",
    "platform" : "nextflow",
    "output" : "/Users/toni/code/projects/viash-hub/workflow_utils/target/nextflow/join/vsh_toList",
    "viash_version" : "0.8.2"
  }
}'''))
]
...
workflow run_wf {
  ...
  main:
    output_ch = input_ch
      ...
      | map{ lst ->
          def new_id = lst[0][1].id
          def old_id = lst[0][0]
          [
            new_id,
            [
              output: lst.collect{ id, state -> state.input },
              _meta: [ join_id: old_id ]
            ]
          ]
        }
