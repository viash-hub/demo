    ...
    "resources" : [
      {
        ...
        "path" : "main.nf",
        "is_executable" : true,
        "parent" : "file:/Users/toni/code/projects/viash-hub/vsh_utils/src/split/expand/",
        "entrypoint" : "run_wf"
      }
    ],
    "description" : "Expand the input wildcard, i.e. convert the input channel with one event\n  `[ _, [ input: <list_of_files> ] ]`\ninto a channel with seperate events of the format:\n  `[ <filename>, [ input: <file> ] ]`\nThis involves some Nextflow and Groovy magic.\n",
    "status" : "enabled",
    "requirements" : {
      "commands" : [
        "ps"
...
meta["defaults"] = [
  ...
  "container" : {
    ...
    "image" : "data-intuitive/vsh_utils/split/expand",
    "tag" : "0.1.0"
  },
  "tag" : "$id"
}'''),
